...
<body>
    ...
    <div class="container">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4">Acceptors List</h1>
                <p class="lead">This Page will show list of Blood seeker</p>
            </div>
        </div>
        <!--    table start-->
        <table id="table_id" class="table table-striped table-bordered shadow-sm p-3 mb-5 bg-white rounded" style="width:100%">
            ...
            <tbody>
                ...
                $num_row = $acceptors->getAllAcceptorsInfo();
                ...
                ?>
                    <?php while ($userrow = mysqli_fetch_array($num_row)) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="reqdel.php?seeker_id=<?php echo $userrow['id']; ?>" onclick="return confirm('Are you sure you wish to delete this Record?');">
