...
$donor = new Donors(); // Checking for user logged in or not

if (isset($_REQUEST['submit'])){
    extract($_REQUEST);
    $status = 0;
    $register = $donor->reg_user($name, $username, $email, $password, $gender, $bloodGroup, $dob, $mobile, $address, $thana, $district, $zip, $lastDonationDate, $status);
    if ($register) {
...
<head>
    ...
    <style>
        ...
        .leftpart{
            ...
            background: -moz-linear-gradient(left, rgba(255,151,76,1) 0%, rgba(242,29,143,1) 100%);
            background: -webkit-gradient(left top, right top, color-stop(0%, rgba(255,151,76,1)), color-stop(100%, rgba(242,29,143,1)));
            background: -webkit-linear-gradient(left, rgba(255,151,76,1) 0%, rgba(242,29,143,1) 100%);
            background: -o-linear-gradient(left, rgba(255,151,76,1) 0%, rgba(242,29,143,1) 100%);
            background: -ms-linear-gradient(left, rgba(255,151,76,1) 0%, rgba(242,29,143,1) 100%);
            background: linear-gradient(to right, rgba(255,151,76,1) 0%, rgba(242,29,143,1) 100%);
            filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#ff974c', endColorstr='#f21d8f', GradientType=1 );
        }
    </style>
    <script>
...
<div>
    ...
    <div class="container">
        <div style="border: 2px solid #00cc00;">
            <div class="row"><div class="col-md-12" style="border: 2px solid #1aff1a; text-align: center;">
                    <h3>To Become a Donor Please Complete Registration Form</h3>
                </div></div>
            <div class="row">
                ...
                <div class="col-md-5 leftpart" style="border: 1px solid #dddddd; ">
                    ...
                    <div>
                        <form action="" method="post" name="PersonForm" onsubmit="return ValidatePersonForm();">
                            ...
                            <input type="text" id="dname" name="name" placeholder="Your name"> <br>
                            <label>Email </label>
                            ...
                            <label for="lastDonationDate">Last Date of Donation</label>
                            <input type="date" name="lastDonationDate"> <br>
                ...
                <div class="col-md-6" style="border: 1px solid #dddddd">
                    ...
                    <img src="../img/donorposter.jpg" alt="" width="100%;">
