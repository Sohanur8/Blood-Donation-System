...
<body>
    ...
    <div class="container">
        <div class="maincontent">
            <div class="row">
                <div class="col-md-12">
                    <h3 style="background-color: dodgerblue;  text-align: center;">Blood Request List</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-12 right-part">
                    ...
                    $select = $reqObject->requestListByAccepterId($acceptor_id);
                    ?>
                                ...
                                while ($userrow = mysqli_fetch_array($select)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="reqdel.php?req_id=<?php echo $userrow['req_id']; ?>" onclick="return confirm('Are you sure you wish to delete this Record?');">
                                        ...
                                        <td>
                                        <a href="donation.php?req_id=<?php echo $userrow['req_id']; ?>" onclick="return confirm(' Great, Donetion completed ?');">
    <span class="fa fa-check-square-o" aria-hidden="true" title="Done"></span></a>
